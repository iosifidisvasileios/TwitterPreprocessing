...
public final class NeutralCorpusMoreThanFourChars {

    static Logger logger = Logger.getLogger(NeutralCorpusMoreThanFourChars.class);
    ...
    private static class MyMapper extends Mapper<LongWritable, Text, Text, Text>{
        protected void map(LongWritable key, Text row, Context context) throws IOException, InterruptedException {
            ...
            try {
                ...
                String text = stringArray[7];
                //if it contains less than 3 words drop
    ...
    public static void main(String[] args) throws Exception {
        ...
        Job job = new Job(configuration, "NeutralCorpusMoreThanFourChars");

        job.setJarByClass(NeutralCorpusMoreThanFourChars.class);
